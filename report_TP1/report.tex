...
Cependant, peut être est-ce simplement parce que nous avons cherché à résoudre les problèmes ci-dessous, et que nous n'avons pas évalué suffisamment de configuration (nombre de processus, nombre de threads, taille du pas...). De même, pour des tailles de mot de passe plus élèvées, nous pouvons raisonnablement penser que la version multi-threadée sera bien plus efficace que la première version car le nombre de vérouillages sera moins important par rapport à l'ensemble des calculs à effectuer qui sera lui bien plus important.
